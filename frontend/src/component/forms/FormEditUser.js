    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-4">
        ...
        <div className="flex justify-center mt-6 pb-[20px]">
          <button
            className={clsx(
              "py-2 mx-auto font-medium rounded-md w-[500px]",
              { "bg-main": showSubmit },
              { "bg-gray-400 text-white": !showSubmit }
            )}
          >
            {data ? "Cập nhật" : "Thêm"}
          </button>
