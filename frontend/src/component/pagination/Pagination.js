    ...
    <div className="flex gap-1">
      {page !== 1 && (
        <div
          ...
          className="w-[37px] h-[37px] flex items-center justify-center border border-gray-300 rounded-md cursor-pointer hover:bg-[#DEE2E6] bg-[-primary]"
        >
          <FaAngleLeft />
        </div>
      )}
      {pagination?.map((item, index) => (
        <div
          ...
          className={`w-[37px] h-[37px] flex items-center justify-center border border-gray-300 rounded-md cursor-pointer hover:bg-[#DEE2E6] ${
            page - 1 === index ? "bg-main font-medium" : ""
          }`}
        >
          {item}
        </div>
